// /components/Sections/PricePartner.jsx — секция «Стоимость участия — Пакет ПАРТНЁР» с фоном и чёрным логотипом
"use client";

import Image from "next/image";

export default function PricePartner() {
          ...
          <div className="sd:pl-72 xz:pl-5 xz:pr-5 sd:pr-10 sd:py-14 xz:py-8">
            ...
            <div className="mt-8">
              ...
              <ul className="mt-3 sd:text-base xz:text-sm text-neutral-800 space-y-2">
                <li>• упоминание компании в период организации (декабрь 2025) в соцсетях организаторов проекта;</li>
